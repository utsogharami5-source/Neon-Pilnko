...
class Particle {
  ...
  draw(ctx: CanvasRenderingContext2D) {
    ...
    // PERFORMANCE: Removed ShadowBlur for mobile optimization
    // ctx.shadowBlur = 10;
...
const AnimatedBackground: React.FC<AnimatedBackgroundProps> = ({ lastDropTime, lastWin }) => {
  ...
  useEffect(() => {
    ...
    // PERFORMANCE: Reduced particle count from 30 to 8 for better mobile performance
    particlesRef.current = Array.from({ length: 8 }, () => new Particle(w, h));
