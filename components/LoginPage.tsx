...
interface LoginPageProps {
    currentUser?: any; // typed loosely to avoid import issues
}
...
const LoginPage: React.FC<LoginPageProps> = ({ currentUser }) => {
  ...
  const handleAuthError = (err: any) => {
      ...
      if (err.code === 'auth/invalid-credential') msg = "Invalid credentials.";
          ...
          msg = "Too many attempts. System locked.";
          setLockoutTime(60);
      }
        ...
        <div className="bg-[#1e2535]/80 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="mt-6">
              <div className="relative flex py-2 items-center">
                  ...
                  <span className="flex-shrink-0 mx-4 text-[10px] text-slate-500 font-bold uppercase tracking-widest">Or Continue With</span>
                  <div className="flex-grow border-t border-slate-700"></div>
              </div>
