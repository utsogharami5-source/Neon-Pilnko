...
const LoginPage: React.FC = () => {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Note: auth/invalid-credential consolidates "user-not-found" and "wrong-password"
  ...
  return (
    <div className="min-h-screen w-full bg-[#0f172a] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-[#1e2535]/80 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full bg-[#0f1522] border-2 border-slate-700 rounded-xl py-3 pl-10 pr-4 text-white font-bold text-sm outline-none focus:border-blue-500 transition-all placeholder:text-slate-600"
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full mt-4 h-12 bg-blue-600 hover:bg-blue-500 text-white font-black uppercase tracking-widest rounded-xl transition-all shadow-[0_4px_0_#1e3a8a] active:translate-y-[4px] active:shadow-none disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
