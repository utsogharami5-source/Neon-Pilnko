            ...
            >
             ...
             <div className="mt-4 text-center">
                <button 
                  ...
                  className="text-slate-400 hover:text-white text-lg sm:text-xl font-bold transition-colors py-3 disabled:opacity-50 mt-2"
                >
                  {isLogin ? t.noAccount : t.haveAccount}
                  <span className="text-lime-400 underline decoration-2 underline-offset-4 decoration-lime-500/50 hover:decoration-lime-400 ml-2">
