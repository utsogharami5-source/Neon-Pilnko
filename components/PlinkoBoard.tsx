...
const PlinkoBoard: React.FC<PlinkoBoardProps> = ({ 
    ...
    Matter.Events.on(render, 'afterRender', () => {
        ...
        bodies.forEach(body => {
            if (body.label === 'ball') {
                ...
                // PERFORMANCE: Very short trails for mobile optimization
        ...
        // Draw Trails - Optimized
        // No gradients, simple strokes for performance
        ctx.lineCap = 'round';
        ctx.lineJoin = 'round';
  ...
  useEffect(() => {
    ...
    if (renderRef.current) {
        ...
        const pr = renderRef.current.options.pixelRatio || 1;
        ...
        >
            ...
            <div className={`w-full h-full relative ${isShaking ? 'animate-shake' : ''}`}>
                ...
                <div className="absolute inset-0 z-0 pointer-events-none rounded-3xl overflow-hidden">
                     <img 
                        src="https://i.ibb.co/Mk42Rg10/20250305-124611.png" 
                        alt="Background" 
                        className="w-full h-full object-cover opacity-20"
                     />
                     <div className="absolute inset-0 bg-gradient-to-b from-[#1a1d29]/80 to-transparent"></div>
                </div>
